...
function adicionarTarefasFixas() {
  const fixas = [
    ...
    {
      titulo: "Lição de Português",
      descricao: "Lição de português até amanhã",
      dataEntrega: "2026-02-06",
      pagina: "pág: 17 e 18 teste",
      tipo: "Lição Comum",
      status: "pendente",
      icone: "🇵🇹",
      origem: "pre-anotadas",
    ...
    {
      titulo: "Lição de História",
      descricao: "Lição de história até segunda",
      dataEntrega: "2026-02-09",
      pagina: "pág 123 ex 2",
      tipo: "Lição Comum",
      status: "pendente",
    ...
    {
      titulo: "Lição de Artes",
      descricao: "Levar materiais que fala na página 15 para quinta que vem",
